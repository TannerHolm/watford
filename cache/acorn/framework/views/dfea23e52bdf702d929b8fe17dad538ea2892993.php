<?php $__env->startSection('content'); ?>
  ...
  <video width="400px" height="700px" playsinline autoplay="autoplay" loop="true" autoplay="autoplay" muted poster="<?= get_field('background_video_poster_image')['url']; ?>" class="home-video" data-src="<?= get_field('background_video')['url']; ?>"> </video>
