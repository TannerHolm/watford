<?php $__env->startSection('content'); ?>
  <video poster="<?= get_field('background_video_poster_image')['url']; ?>" loop playsinline autoplay muted class="home-video" data-src="<?= get_field('background_video')['url']; ?>"> </video>
