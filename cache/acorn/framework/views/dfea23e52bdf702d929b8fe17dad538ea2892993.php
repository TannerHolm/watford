<?php $__env->startSection('content'); ?>
  ...
  <video width="100%" height="100%" playsinline autoplay="autoplay" loop="true" autoplay="autoplay" muted poster="<?= get_field('background_video_poster_image')['url']; ?>" class="home-video" data-src="<?= get_field('background_video')['url']; ?>"> </video>
